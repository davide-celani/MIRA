...
config <- mira_info_long(
  data,
  inspect_only = TRUE
)

# Chiamata completamente automatica
result <- mira_info_long(data)
...
prior <- mira_prior_long(stan_data, outcome = "BCVA")
