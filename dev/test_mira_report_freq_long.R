# Reproducible examples for mira_info_long() and mira_report_freq_long().
...
core_fit <- mira_info_long(core_data, id = "subject_id", outcomes = "score",
...
correlation_fit <- mira_info_long(correlation_data, id = "subject_id",
...
arm_fit <- mira_info_long(arm_data, id = "subject_id", outcomes = "score",
...
multi_fit <- mira_info_long(multi_data, id = "subject_id",
...
sparse_fit <- mira_info_long(sparse_data, id = "subject_id", outcomes = "score",
